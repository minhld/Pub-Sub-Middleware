...
public class Broker2 extends Thread {
    ...
    public Broker2(Context parentContext, String brokerIp) {
    ...
    private void initRouterMode() {
        ...
        Broker2.jobMergeList = new HashMap<String, JobMergeInfo>();
            ...
            if (items.pollin(0)) {
                ...
                if (clientId.equals(Utils.WORKER_READY)) {
                    ...
                    if (jobMergeInfo.isPlaceholderFilled()) {
                        ...
                        Broker2.jobMergeList.remove(jobMergeInfo.clientId);
            ...
            super(context, brokerIp, new AckListener() {
                ...
                public void allAcksReceived() {
                    ...
                    try {
                        ...
                        Broker2.jobMergeList.put(AckServerListener.request.clientId, jobMergeInfo);
    ...
    private JobMergeInfo mergeTaskResults(String useClientId, byte[] taskBytes) {
        ...
        JobMergeInfo jobInfo = Broker2.jobMergeList.get(clientId);
        ...
        if (!jobInfo.isPlaceholderFilled()) {
            ...
            Broker2.jobMergeList.put(clientId, jobInfo);
        }
