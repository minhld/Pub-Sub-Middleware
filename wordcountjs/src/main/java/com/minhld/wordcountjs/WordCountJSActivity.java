...
public class WordCountJSActivity extends AppCompatActivity {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case Utils.MESSAGE_INFO: {
                    ...
                    UITools.writeLog(WordCountJSActivity.this, infoText, strMsg);
                    break;
                }
            }
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_word_count_js);
    ...
    private void initSystem() {
        ...
        UITools.writeLog(WordCountJSActivity.this, infoText, "server started");
    }
    ...
    private void initWorker() {
        ...
        new MidWorker(this, brokerIp) {
            ...
            public void workerStarted(String workerId) {
                UITools.writeLog(WordCountJSActivity.this, infoText, "worker [" + workerId + "] started.");
            }

            @Override
            public void receivedTask(String clientId, int dataSize) {
                UITools.writeLog(WordCountJSActivity.this, infoText, "worker [" + this.workerId + "] received " + dataSize + " bytes from client [" + workerId + "].");
            }
    ...
    private void initClient() {
        Client client = new Client(Utils.BROKER_SPECIFIC_IP) {
            ...
            public void clientStarted(String clientId) {
                // print out
                UITools.writeLog(WordCountJSActivity.this, infoText, "client [" + clientId + "] started");
            }
            ...
            public void send() {
                ...
                try {
                    JobSupporter.initDataParser(WordCountJSActivity.this, jobPath);
                    ...
                    // print out
                    UITools.writeLog(WordCountJSActivity.this, infoText, "client sent: " + jobPkg.length);
            ...
            public void resolveResult(byte[] result) {
                ...
                UITools.writeLog(WordCountJSActivity.this, infoText, "client received result: " + result.length + " bytes");
                ...
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            UITools.writeLog(WordCountJSActivity.this, infoText, resultStr);
                            UITools.writeLog(WordCountJSActivity.this, infoText, "total time: " + durr + "ms");
                        }
                    });
                } catch (Exception e) {
                    e.printStackTrace();
