package com.minhld.internetsharetest;
...
import com.minhld.internetsharetest.R;
...
public class InternetShareActivity extends AppCompatActivity {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case Utils.MESSAGE_INFO: {
                    ...
                    UITools.writeLog(InternetShareActivity.this, infoText, strMsg);
                    break;
                }
            }
        }
    ...
    private void initSystem() {
        ...
        UITools.writeLog(InternetShareActivity.this, infoText, "server started");
    }
    ...
    private void initWorker() {
        ...
        new MidWorker(this, brokerIp) {
            ...
            public void workerStarted(String workerId) {
                UITools.writeLog(InternetShareActivity.this, infoText, "worker [" + workerId + "] started.");
            }

            @Override
            public void receivedTask(String clientId, int dataSize) {
                UITools.writeLog(InternetShareActivity.this, infoText, "worker [" + this.workerId + "] received " + dataSize + " bytes from client [" + workerId + "].");
            }

            @Override
            public void workerFinished(String workerId, TaskDone taskDone) {
                UITools.writeLog(InternetShareActivity.this, infoText, "worker [" + this.workerId + "] finished job. time: " + taskDone.durration);
            }
    ...
    private void initClient() {
        Client client = new Client(Utils.BROKER_SPECIFIC_IP) {
            ...
            public void clientStarted(String clientId) {
                // print out
                UITools.writeLog(InternetShareActivity.this, infoText, "client [" + clientId + "] started");
            }
            ...
            public void send() {
                ...
                try {
                    JobSupporter.initDataParser(InternetShareActivity.this, jobPath);
                    ...
                    // print out
                    UITools.writeLog(InternetShareActivity.this, infoText, "client sent: " + jobPkg.length);
            ...
            public void resolveResult(byte[] result) {
                ...
                UITools.writeLog(InternetShareActivity.this, infoText, "client received result: " + result.length + " bytes");
                ...
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            UITools.writeLog(InternetShareActivity.this, infoText, resultStr);
                            UITools.writeLog(InternetShareActivity.this, infoText, "total time: " + durr + "ms");
                        }
                    });
                } catch (Exception e) {
                    e.printStackTrace();
